...
/**
 * Idea per i cookie:
 * 1) Prendere hash di username utente + data attuale (usata come salt)
 * 2)creare cookie di login persistente (diverso da cookie di sessione) con tale hash
 * 3) salvare in database lo stesso hash (magari nuova colonna in tabella user)
 * 4) al login, js manda cookie e php controlla se hash in cookie == hash in database, se non valido si esegue login normalmente
 * 5) se valido redirect da js in a index.
 * 
 * 
 * 
 * 
